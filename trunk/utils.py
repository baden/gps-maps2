...
def GetUserByKey(key):
	...
	userdb = datamodel.DBUser().get(db.Key(key))
	return userdb

def GetUserByIMEI(uimei):
...
#
# Необходимо переделать на работу с memcache!!!
# а также, возможно, добавить остальной функционал (обновление прошивки, и т.п.)
#
